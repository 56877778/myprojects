<?php
$pageTitle='تفاصيل طلاب لقسم مخصص';
...
<div class="container wonder">
  ...
  <div class="row">
    ...
    <div class="text-center">
          ...
          <h2 class="text-center"><strong> تفاصيل طلاب لقسم مخصص </strong><i class=" fa fa-th-list fa-2x "></i></h2>
        </div>
...
<div class="col-sm-2 pull-right" style="display:none;" id="back_to_table">
<div  class="form-group form-group-lg" >
...
<div class="row collapse" id="add_selects_collapse">
<div class="col-sm-4 pull-right">
<div  class="form-group form-group-lg">
    <label for="level" class="control-label">المستوى</label>
          ...
          class="form-control"  ng-change="loadbatch()"  >
...
<div  class="form-group form-group-lg">
    ...
    <label for="batch" class=" control-label">الدفعة</label>
       ...
       ng-model="batch" class="form-control"   onchange="Load_students_department()">
...
<div class="row">
    ...
    <div class="col-sm-4 text-center pull-right"  id="reset" style="display:none;">
  ...
  <div  class="form-group form-group-sm" id="add_selects" style="display:none;">
    <label  class=" control-label text-center">تمدد</label>
    <div class="" >
...
<div class="panel-body ">
  <div class="row">
               ...
               <div class="col-sm-4  fantastic input-group ">
...
?>
<script>
function btn_dept_student_list(){
...
if( department>=1 & course>=1){


    var Load_students_department = "Load";
    $.ajax({
    url:"includes/classes/student_details/action.php",
    method:"POST",
    data:{ Load_students_department:Load_students_department,department:department,course:course,level:level,batch:batch},
...
//  $('#example_filter').hide();
    ...
    $('#students_department_table').html('  <h1 class="text-center"  ><a>  <u> حدد القسم والتخصص معا </u></a>  </h1>');
  }
