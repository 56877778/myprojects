...
<div><a href="enter_student_degree_was_failed.php?exam_id='.$examId.'" class="btn btn-sm btn-danger" ><span class="badge">'.$count_student_failed_avaliable.'</span> عرض الطلاب الباقون</a>
<a href="enter_student_degree_was_last.php?exam_id='.$examId.'" class="btn btn-sm btn-danger"  ><span class="badge">'.$count_last_student.'</span> جديد  </a>
