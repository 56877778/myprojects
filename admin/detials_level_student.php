<?php
$pageTitle='تفاصيل طلاب لمستوئ مخصص';
...
<div class="container wonder">
  ...
  <div class="row">
    ...
    <div class="text-center">
          ...
          <h2 class="text-center"><strong> تفاصيل طلاب لمستوئ مخصص </strong><i class=" fa fa-th-list fa-2x "></i></h2>
        </div>
...
<div class="row"   id="reset" style="display:none;">
  ...
  color: #fff !important;"><h4 class="text-center "> <strong> القسم :{{name.dept_name}} /  التخصص:{{name.course_name}}/ المستوئ:{{name.level_name}} / الدفعة:{{name.batch_name}}</strong></h4>
